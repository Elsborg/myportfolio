...
const Intro = () => {
    return (
        <div className='flex items-center flex-row justify-around pt-20 pb-6'>
            <div className='flex flex-col'>
            <h1 className='text-4xl md:text-7xl dark:text-white mb-1 md:mb-3 font-bold'>Martin</h1>
            <p className='text-base md_text-xl mb-3 font-medium'>Frontend developer & UX/UI Designer</p>
            ...
            <img className='rounded-full px-8' src={image} />
        </div>
    )
}
